...
5. **Background, Claude, between cluster sessions:** `C-02` tests (unblocks `C-06` immediately), `C-06` repository refactor, `S-02` aggregator, and the cosmetic defects `D-09`/`D-10`. These fill gaps rather than gating anything.
