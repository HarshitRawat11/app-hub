...
> **Corrected 2026-09-13.** This entry first said **39 seconds**. Re-timed twice the next day — 102 s and 114 s — so 39 s was one warm run recorded as if it were the number. The improvement is real (573 s → ~110 s, about 5×); the figure was optimistic and nothing re-measured it until `S-03` happened to. **A number with no consumer is untested**, same as every other stale claim here.
